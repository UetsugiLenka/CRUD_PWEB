                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <option value="FE" <?php if ($fakultas == "FE") echo "selected" ?>>Fakultas Ekonomi</option>
                            <option value="FH" <?php if ($fakultas == "FH") echo "selected" ?>>Fakultas Hukum</option>
                            <option value="FTI" <?php if ($fakultas == "FTI") echo "selected" ?>>Fakultas Ilmu Komputer dan Teknologi Informasi</option>
                            <option value="FK" <?php if ($fakultas == "FK") echo "selected" ?>>Fakultas Kedokteran</option>
                            <option value="FP" <?php if ($fakultas == "FP") echo "selected" ?>>Fakultas Psikologi</option>
                            ...
                            <option value="FKP" <?php if ($fakultas == "FKP") echo "selected" ?>>Fakultas Keguruan dan Ilmu Pendidikan</option>
                            <option value="FBP" <?php if ($fakultas == "FBP") echo "selected" ?>>Fakultas Bisnis dan Pascasarjana</option>
